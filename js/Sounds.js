class Sounds {
    constructor(game) {
        ...
        this.MUSIC_CELEBRATE = new AsyncAudio('audio/music_celebrate.mp3');
        this.MUSIC_STATS = new AsyncAudio('audio/music_stats.mp3');
        this.MUSIC_WIN = new AsyncAudio('audio/music_win.mp3');
        this.MUSIC1 = new AsyncAudio('audio/music1.mp3');
        this.MUSIC1_FAST = new AsyncAudio('audio/music1_fast.mp3');
        this.MUSIC2 = new AsyncAudio('audio/music2.mp3');
        this.MUSIC2_FAST = new AsyncAudio('audio/music2_fast.mp3');
        this.MUSIC3 = new AsyncAudio('audio/music3.mp3');
        this.MUSIC3_FAST = new AsyncAudio('audio/music3_fast.mp3');
    }
}
